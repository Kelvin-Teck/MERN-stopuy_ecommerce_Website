	...
	return <div>
		...
		<div className="container small-container">
			...
			<Form onSubmit={submitHandler}>
				...
				<div className="mb-3">
					<Form.Check type="radio" id="PayOnDelivery" label="Pay On Delivery" value="PayOnDelivery" checked={paymentMethodName === 'PayOnDelivery'} onChange={(e) => setPaymentMethodName(e.target.value)}/>
				</div>
